...
//logMessage(LOG_INFO, "mqtt_broadcast_aqualinkstate: START\n");
  ...
  if (_aqualink_data->pool_temp != TEMP_UNKNOWN && _aqualink_data->pool_temp != _last_mqtt_aqualinkdata.pool_temp) {
    ...
    send_mqtt_temp_msg_new(nc, POOL_TEMPERATURE_TOPIC, _aqualink_data->pool_temp);
    send_mqtt_temp_msg_new(nc, POOL_THERMO_TEMP_TOPIC, _aqualink_data->pool_temp);
  ...
  if (_aqualink_data->spa_temp != TEMP_UNKNOWN && _aqualink_data->spa_temp != _last_mqtt_aqualinkdata.spa_temp) {
    ...
    send_mqtt_temp_msg_new(nc, SPA_TEMPERATURE_TOPIC, _aqualink_data->spa_temp);
    send_mqtt_temp_msg_new(nc, SPA_THERMO_TEMP_TOPIC, _aqualink_data->pool_temp);
    ...
    send_mqtt_temp_msg_new(nc, SPA_TEMPERATURE_TOPIC, _aqualink_data->pool_temp);
    send_mqtt_temp_msg_new(nc, SPA_THERMO_TEMP_TOPIC, _aqualink_data->pool_temp);
